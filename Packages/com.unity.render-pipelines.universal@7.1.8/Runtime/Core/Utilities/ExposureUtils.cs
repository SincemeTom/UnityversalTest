...
namespace UnityEngine.Rendering.GRenderPipeline {
    public class ExposureUtils  {
       public static float Ev100(float aperture, float shutterSpeed, float sensitivity) {
            ...
            return (float)System.Math.Log((aperture * aperture) / shutterSpeed * 100.0f / sensitivity,2.0f);
        }
        ...
        public static float Ev100FromLuminance(float luminance) {
            ...
            //
            // Reference: https://en.wikipedia.org/wiki/Exposure_value
            return (float)System.Math.Log(luminance * (100.0f / 12.5f));
        }
        ...
        public static float Ev100FromIlluminance(float illuminance) {
            ...
            //
            // Reference: https://en.wikipedia.org/wiki/Exposure_value
            return (float)System.Math.Log(illuminance * (100.0f / 250.0f));
        }
        ...
        public static float Exposure(float ev100) {
            ...
            return (1.0f / (1.2f * Mathf.Pow(2.0f, ev100)));
        }
        ...
        public static float Luminance(float ev100) {
            ...
            //
            // Reference: https://en.wikipedia.org/wiki/Exposure_value
            return Mathf.Pow(2.0f, ev100 - 3.0f);
        }
